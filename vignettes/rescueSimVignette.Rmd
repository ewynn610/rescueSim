...
vignette: >
  %\VignetteIndexEntry{rescueSimVignette}
...
|:------------------:|:--------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
|   `nTimepoints`    |                \-                |                                                                                 Number of timepoints (i.e. samples) per subject                                                                                  |                                                                      Single numeric value \>0 representing the number of timepoints for all subjects.                                                                     |
...
`estRescueSimParams` function. Users provide a dataset in the form of a
...
getRescueSimParam(myParams_estimated, "deLogFC")
```
...
timepoint since `rescueSim` simulates linear differential expression across
time.
